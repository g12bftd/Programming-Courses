---
title: "9.2 - Linear Discriminant Analysis"
output: html_notebook
author: Glenn Bucagu
---
LDA is ideal for linearly separable classification problems.

```{r setup, include=FALSE}
knitr::opts_chunk$set(echo = TRUE)
knitr::opts_knit$set(root.dir = "~/Desktop/Projects/Machine Learning A-Z (Codes and Datasets)/Part 9 - Dimensionality Reduction/Section 44 - Linear Discriminant Analysis (LDA)/R")
```
...
# 100% accuracy with respect to test set predictions!
```
